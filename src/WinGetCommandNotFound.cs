...
namespace wingetprovider
{
    ...
    public sealed class WinGetCommandNotFoundFeedback : IFeedbackProvider
    {
        ...
        public WinGetCommandNotFoundFeedback(string guid)
        {
            ...
            var dbPath = new FileInfo(Environment.GetFolderPath(Environment.SpecialFolder.ProgramFiles) + @"\WindowsApps\Microsoft.Winget.Source_2023.202.1839.736_neutral__8wekyb3d8bbwe\public\index.db");
            if (!dbPath.Exists)
            {
